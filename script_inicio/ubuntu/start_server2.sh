...
cd server2-emotion || exit

# 2. Comprobar el módulo venv de Python para Ubuntu
# A diferencia de Arch, Ubuntu requiere instalar python3-venv por separado
...
# 5. Leer el puerto desde .env (default 8002)
